    ...
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item <?php if($page == 'blog'): ?> active <?php endif; ?>">
                            <a href="<?= url('admin/blog') ?>" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item <?php if($page == 'pengguna'): ?> active <?php endif; ?>">
        ...
        <div id="main">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2 align-items-center btn btn-primary">
                    {{ auth()->user()->name }}
